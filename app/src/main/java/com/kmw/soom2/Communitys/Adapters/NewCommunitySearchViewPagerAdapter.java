...
public class NewCommunitySearchViewPagerAdapter extends PagerAdapter {
...
//    YourGlideModule yourGlideModule;
    ...
    public NewCommunitySearchViewPagerAdapter(Context context, int flag) {
...
//        yourGlideModule = new YourGlideModule(context);
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        view = inflater.inflate(R.layout.view_new_community_search_view_pager_list_item, null);
...
//            GlideApp.with();
            ...
            if (flag == 1) {
                ...
                if (listViewItems.get(position).contains("https:")) {
                    Glide.with(context).load(replaceText).override(100,100).apply(requestOptions).into(img);
                } else {
                    Glide.with(context).load("https:" + replaceText).override(100,100).apply(requestOptions).into(img);
                }
            } else {
