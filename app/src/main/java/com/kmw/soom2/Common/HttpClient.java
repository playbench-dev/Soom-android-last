...
public class HttpClient {
    ...
    private void setRequestMethod(HttpURLConnection connection) {
        ...
        public void addOrReplace(String key, String value) { this.parameters.put(key, value); }
        public void addOrReplace(String key, char value) { this.parameters.put(key, value); }
