...
public class CropImageActivity extends MonitoredActivity {
    ...
    private com.kmw.soom2.Common.Activity.CropImageView imageView;
    ...
    private void setupViews() {
        ...
        imageView = (com.kmw.soom2.Common.Activity.CropImageView) findViewById(R.id.crop_image);
    ...
    private void loadInput() {
        ...
        if (sourceUri != null) {
            ...
            Log.i("CropImage","rotation : " + exifRotation);
            InputStream is = null;
            try {
...
//            if (preferences.getBoolean("picture",false) == false){
