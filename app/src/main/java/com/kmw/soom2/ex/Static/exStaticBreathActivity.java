...
import com.kmw.soom2.Reports.Activitys.StaticBreathNoResultDetailInfoActivity;
...
public class exStaticBreathActivity extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ex_static_breath);
    ...
    public void viewSetting() {
        ...
        txtMinValue.setText("240");
        txtMaxValue.setText("400");
        txtRateValue.setText("60%");

        historyListMake(1);
        historyListMake(2);
    }

    void historyListMake(int flag) {
    ...
    void findViewByIds() {
        ...
        btnMove = findViewById(R.id.btn_ex_breath_static_move);

        btnMove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(exStaticBreathActivity.this, NewAnotherLoginActivity.class);
