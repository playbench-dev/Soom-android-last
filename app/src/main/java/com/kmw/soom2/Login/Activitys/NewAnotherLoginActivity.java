...
public class NewAnotherLoginActivity extends AppCompatActivity implements View.OnClickListener , AsyncResponse {

    private String                      TAG = "NewAnotherLoginActivity";
    private ImageView                   mImageBack;
    private LinearLayout                mLineaKakao;
    private LinearLayout                mLinearNaver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_another_login);
        ...
        mLineaKakao                     = findViewById(R.id.lin_new_another_login_kakao_login);
        mLinearNaver                    = findViewById(R.id.lin_new_another_login_naver_login);
        ...
        mLineaKakao.setOnClickListener(this);
        mLinearNaver.setOnClickListener(this);
        ...
        mAgreeBottomSheetDialog         = new BottomSheetDialog(NewAnotherLoginActivity.this);
    ...
    public void MarketingOneBtnPopup(Context context) {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (flag == 1){
                    Intent intent = new Intent(NewAnotherLoginActivity.this, EmailSignupActivity.class);
                    intent.putExtra("LOGIN_TYPE", 1);
                    startActivity(intent);
                }else if (flag == 2){
                    Intent i = new Intent(NewAnotherLoginActivity.this, SnsSignupActivity.class);
    ...
    Function2<OAuthToken, Throwable, Unit> callBack = new Function2<OAuthToken, Throwable, Unit>() {
        ...
        public Unit invoke(OAuthToken oAuthToken, Throwable throwable) {
            ...
            if (throwable != null){
                Toast.makeText(NewAnotherLoginActivity.this, "현재 카카오 로그인에 문제가 발생했습니다.", Toast.LENGTH_SHORT).show();
            }
        ...
        UserApiClient.getInstance().me(new Function2<User, Throwable, Unit>() {
            ...
            public Unit invoke(User user, Throwable throwable) {
                if (user != null){ //로그인 상태
                    ...
                    Toast.makeText(NewAnotherLoginActivity.this, "kakaoLogin : " + throwable.getMessage(), Toast.LENGTH_SHORT).show();
                }
                return null;
            }
        });
                ...
                FirebaseMessaging.getInstance().getToken()
                        .addOnCompleteListener(new OnCompleteListener<String>() {
                            ...
                            public void onComplete(@NonNull Task<String> task) {
                                ...
                                new NetworkUtils.NetworkCall(NewAnotherLoginActivity.this,NewAnotherLoginActivity.this,TAG,mCode).execute(id,Utils.TOKEN);
                ...
                try {
                    ...
                    if (jsonArray.length() > 0) {
                        ...
                        if (JsonIntIsNullCheck(object, "ALIVE_FLAG") == 1) {
                            ...
                            USER_INFO_SHARED(NewAnotherLoginActivity.this,userItem);
                            ...
                            Intent intent = new Intent(NewAnotherLoginActivity.this,MainActivity.class);
                            ...
                            new OneButtonDialog(NewAnotherLoginActivity.this, "탈퇴한 계정", "탈퇴한 계정입니다.\n새로운 이메일의 소셜계정이나 이메일 가입하기를 이용해주세요.", "확인");
                        }
                    } else {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.lin_new_another_login_kakao_login : {
            ...
            case R.id.lin_new_another_login_naver_login : {
