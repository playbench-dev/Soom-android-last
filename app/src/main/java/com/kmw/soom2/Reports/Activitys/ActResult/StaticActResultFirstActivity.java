...
public class StaticActResultFirstActivity extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    void FindViewById(){
        ...
        txtDate = (TextView)findViewById(R.id.txt_check_first_date);
        ...
        rdo2.setText((actType == 1) ? R.string.adult_check_page1_rdo_2 : R.string.kids_check_page1_rdo_2);
        rdo3.setText((actType == 1) ? R.string.adult_check_page1_rdo_3 : R.string.kids_check_page1_rdo_3);
        rdo4.setText((actType == 1) ? R.string.adult_check_page1_rdo_4 : R.string.kids_check_page1_rdo_4);
        rdo5.setText((actType == 1) ? R.string.adult_check_page1_rdo_5 : R.string.kids_check_page1_rdo_5);
