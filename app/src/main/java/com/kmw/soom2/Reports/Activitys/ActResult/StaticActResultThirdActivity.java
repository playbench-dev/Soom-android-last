...
public class StaticActResultThirdActivity extends AppCompatActivity implements View.OnClickListener  {
    ...
    void FindViewById(){
        ...
        txtDate = (TextView)findViewById(R.id.txt_check_third_date);
        ...
        rdo2.setText((actType == 1) ? R.string.adult_check_page3_rdo_2 : R.string.kids_check_page3_rdo_2);
        rdo3.setText((actType == 1) ? R.string.adult_check_page3_rdo_3 : R.string.kids_check_page3_rdo_3);
        rdo4.setText((actType == 1) ? R.string.adult_check_page3_rdo_4 : R.string.kids_check_page3_rdo_4);
        rdo5.setText((actType == 1) ? R.string.adult_check_page3_rdo_5 : R.string.kids_check_page3_rdo_5);
