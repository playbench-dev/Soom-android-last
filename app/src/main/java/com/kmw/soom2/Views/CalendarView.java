...
//        );
    ...
    private void setUpWeekDaysLayout() {
        ...
        String[] weekDaysArray = new DateFormatSymbols(Locale.ENGLISH).getWeekdays();
    ...
    private void markDayAsCurrentDay() {
        ...
        if (nowCalendar.get(Calendar.YEAR) == currentCalendar.get(Calendar.YEAR) && nowCalendar.get(Calendar.MONTH) == currentCalendar.get(Calendar.MONTH)) {
            ...
            dayOfText.setTextColor(Color.WHITE);
    ...
    private void markDayAsSelectedDay(Calendar calendar) {
        ...
        dayOfTheMonth.setTextColor(ContextCompat.getColor(context, R.color.calendar_selected_day_font));
        ...
        if (circleImage1.getVisibility() == VISIBLE) {
            DrawableCompat.setTint(circleImage1.getDrawable(), ContextCompat.getColor(context, R.color.calendar_selected_day_font));
        }

        if (circleImage2.getVisibility() == VISIBLE) {
            DrawableCompat.setTint(circleImage2.getDrawable(), ContextCompat.getColor(context, R.color.calendar_selected_day_font));
        }
    }
    ...
    private void clearSelectedDay(Calendar calendar) {
        if (calendar != null) {
            ...
            ImageView circleImage2 = getCircleImage2(calendar);
            if (circleImage1.getVisibility() == VISIBLE) {
                DrawableCompat.setTint(circleImage1.getDrawable(), ContextCompat.getColor(context, R.color.calendar_circle_1));
            }

            if (circleImage2.getVisibility() == VISIBLE) {
                DrawableCompat.setTint(circleImage2.getDrawable(), ContextCompat.getColor(context, R.color.calendar_circle_2));
            }
        }
    }
    ...
    public void markCircleImageLow(Calendar calendar) {
        ImageView circleImage1 = getCircleImage1(calendar);
        circleImage1.setImageResource(R.drawable.ovulation_circle_low);
        circleImage1.setVisibility(VISIBLE);
    ...
    public interface RobotoCalendarListener {
        ...
        void onRightButtonClick(Calendar daySelectedCalendar);

        void onLeftButtonClick(Calendar daySelectedCalendar);
    }
